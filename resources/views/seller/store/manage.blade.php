...
<div class="main-content-wrap">
        ...
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Stores Manage</div>
                </li>
            </ul>
        </div>
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="{{route('stores.create')}}"><i
            ...
            <div class="wg-table table-all-use p-1">
                <table class="table table-hover table-bordered ">
                    ...
                    <tbody>
                        <tr>
                            <td>{{$store->id}}</td>
                            <td class="pnam">{{$store->store_name}}</td>
                            <td class="pnam">{{$store->slug}}</td>
                            <td class="pnam">{{$store->details}}</td>
                            <td>
