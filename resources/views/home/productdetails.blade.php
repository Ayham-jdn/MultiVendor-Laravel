      ...
      <div class="row">
                ...
                <div class="swiper-wrapper">
                  @foreach ($product->images as $image)
                    <div class="swiper-slide product-single__image-item">
                      <img loading="lazy" class="h-auto"  src="{{ asset($image->img_path) }}" width="674"
                        height="674" alt="" />
        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            ...
            <div class="product-single__prev-next d-flex align-items-center 
            justify-content-between justify-content-md-end flex-grow-1">
            @if ($prev)
              <a href="{{ route('products.show', $prev->id) }}" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25"
                  xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_prev_md" />
                </svg><span class="menu-link menu-link_us-s">Prev</span></a>
                @else
                <a class="text-muted text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25"
                  xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_prev_md" />
                </svg><span class="text-muted menu-link menu-link_us-s">Prev</span></a>
            @endif  
            @if ($next)      
              <a href="{{ route('products.show', $next->id) }}" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Next</span><svg
                  width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_next_md" />
                </svg></a>
                @else
                <a class=" text-uppercase fw-medium"><span class="text-muted menu-link menu-link_us-s">Next</span><svg
                  width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_next_md" />
                </svg></a>
            @endif
          ...
          <div class="product-single__price">
            ...
            <div class="price-box">
                ...
                <div class="d-flex flex-column">
                    @if ($discountPercent)
                        <span class=" fw-light mt-1"  style="color: #c20000">- {{ $discountPercent }}%</span>

                    @endif                    
                    <div>
                        <span class="currency">EGP</span>
                        <span class="main-price  fw-bold">{{ $discmain }}</span>
                        <span class="fraction-price">{{ $fraction }}</span>
                    </div>

                    <span class="text-muted fs-6">List price: 
                        <span class="text-muted text-decoration-line-through">{{ $main }}.{{ $fraction }}</span> 
                    </span>

                </div>
                @else  
                    <span class="currency">EGP</span>
                    <span class="main-price">{{ $main }}</span>   
                    <span class="fraction-price">{{ $fraction }}</span>          
                @endif
            </div>
          </div>
